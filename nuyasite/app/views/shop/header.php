...
<head>
    ...
    <link rel="stylesheet" id="gameStyle" href="<?=URI::public_path('css/animate.css')?>" type="text/css" />
	<link rel="stylesheet" id="gameStyle" href="<?=URI::public_path('css/extra.css')?>" type="text/css" />
