...
<div class="content clearfix" id="wt_refpoint">
    <div id="category">
        ...
        <h2>
            <ul class="breadcrumb">
                <li>
                    <a href="#" title="En gözdeler">KasaGame Ödeme Yöntemi</a>
                </li>
            </ul>
        </h2>
        ...
        <div class="tabbable tabs-left">
            ...
            <div class="tab-content">
                ...
                <div class="scrollable_container row-fluid">
                    ...
                    <div class="paywant animated infinite pulse" align="center" style="margin-top: 50px;"><a href='kasagame#kasaGameModal' ><img style="margin-left:-7px"src="<?= URI::public_path('images/kasagame.png')?>" border="0"/></a></div>

                    <div class="remodal" data-remodal-id="kasaGameModal">
                        <div class="login-body">
                                            <?php
												if($_SESSION["aId"] != "")
												{
													...
													if(count($sorgu) > 0 )
													{
														$merchant_id=\StaticDatabase\StaticDatabase::settings('kasagame_merc_id');
														$api_key=\StaticDatabase\StaticDatabase::settings('kasagame_api_key');
														$return_id=$_SESSION["cLogin"];
														$curl = curl_init();
														...
														else 
														{
															...
															if ($obj->success=="100"){
															echo '<iframe seamless="seamless" id="kasaGameFrame" style="display:block; width:1024px; height:650px;" frameborder="0" scrolling="yes" src="'.$obj->message.'" id="odemeFrame"></iframe>';
															}else {echo $response;}
														}
                                            ...
                                            <script type="text/javascript">
                                                (function (wd, doc) {
                                                    ...
                                                    if (screenSize.w > 0 && screenSize.w < 1025) {
                                                        document.getElementById('kasaGameFrame').style.width = '650px';
                                                    }
                                                })(window, document);
                                            </script>
                        </div>
