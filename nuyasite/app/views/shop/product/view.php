						...
						<?php if ($getSubMenu->rowCount() > 0):?>
                            <ul class="dropdown-menu ">
								<?php foreach ($subMenu as $keys=>$rows):?>
                                    <li class="has-subnavi">
                                        <a class="btn-subcatitem" href="<?=URI::get_path('product/view/'.$rows['id'])?>"><?=$rows['name'];?></a>
                                    </li>
								<?php endforeach;?>
                            </ul>
						<?php endif;?>
                                ...
                                <div class="desc row-fluid">
                                    <div class="item-description">
                                        <p class="item-status js_currency_default">
											<?php if (($row['item_time'] == 1) AND ($row['vnum'] != 50027 and $row['vnum'] != 70111 and $row['vnum'] != 70112)):?>
                                        ...
                                        <div class="item-shortdesc clearfix">
                                            ...
                                            <div class="fancybox fancybox.ajax" href="<?=URI::get_path('product/ajax/'.$row['item_id'].'&token='.$itemToken)?>">
                                                <p class="item-box-description">
													<?php if ($row['attrtype0'] > 0 and $row['attrtype1'] > 0 and $row['attrtype2'] > 0 and $row['attrtype3'] > 0 and $row['attrtype4'] > 0){ ?>
													<?php echo "".$efsun[$row['attrtype0']]."".$row['attrvalue0']."<br>".$efsun[$row['attrtype1']]."".$row['attrvalue1']."<br>".$efsun[$row['attrtype2']]."".$row['attrvalue2']."<br>".$efsun[$row['attrtype3']]."".$row['attrvalue3']."<br>".$efsun[$row['attrtype4']]."".$row['attrvalue4'].""; ?>
													<?php }else if ($row['attrtype0'] > 0 and $row['attrtype1'] > 0 and $row['attrtype2'] > 0 and $row['attrtype3'] > 0 and $row['attrtype4'] == 0){ ?>
													<?php echo "".$efsun[$row['attrtype0']]."".$row['attrvalue0']."<br>".$efsun[$row['attrtype1']]."".$row['attrvalue1']."<br>".$efsun[$row['attrtype2']]."".$row['attrvalue2']."<br>".$efsun[$row['attrtype3']]."".$row['attrvalue3'].""; ?>
													<?php }else if ($row['attrtype0'] > 0 and $row['attrtype1'] > 0 and $row['attrtype2'] > 0 and $row['attrtype3'] == 0 and $row['attrtype4'] == 0){ ?>
													<?php echo "".$efsun[$row['attrtype0']]."".$row['attrvalue0']."<br>".$efsun[$row['attrtype1']]."".$row['attrvalue1']."<br>".$efsun[$row['attrtype2']]."".$row['attrvalue2'].""; ?>
													<?php }else if ($row['attrtype0'] > 0 and $row['attrtype1'] > 0 and $row['attrtype2'] == 0 and $row['attrtype3'] == 0 and $row['attrtype4'] == 0){ ?>
													<?php echo "".$efsun[$row['attrtype0']]."".$row['attrvalue0']."<br>".$efsun[$row['attrtype1']]."".$row['attrvalue1'].""; ?>
													<?php }else if ($row['attrtype0'] > 0 and $row['attrtype1'] == 0 and $row['attrtype2'] == 0 and $row['attrtype3'] == 0 and $row['attrtype4'] == 0){ ?>
													<?php echo "".$efsun[$row['attrtype0']]."".$row['attrvalue0'].""; ?>
													<?php }else{?> <?=$row['description']; }?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
