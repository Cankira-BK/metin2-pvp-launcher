                ...
                <div class="error-holder">
                    <div class="container_3 red wide fading-notification" align="left">
						...
						if($cError == 'recaptcha'){
							...
							echo Functions::alert('info',$lng[192]);
						}
						?>
                    </div>
                </div>
                <form action="<?=URI::get_path('profile/ikschange')?>" method="post" accept-charset="utf-8" class="page_form">
                    <table style="width:500px;">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <span class="warfg_btn"><input type="submit" name="login_submit" value="<?=$lng[193]?>"></span>
                            </td>
                        </tr>
                    </table>
                </form>
