                ...
                <div class="error-holder">
                    <div class="container_3 red wide fading-notification" align="left">
						...
						if($cError == 'recaptcha'){
							...
							echo Functions::alert('success',$lng[77]);
							Session::set('cError',false);
						}
						?>
                    </div>
                </div>
                <form action="<?=URI::get_path('recuperare/control2')?>" id="RecuperareNotifyOGs" method="post" accept-charset="utf-8" class="page_form">
