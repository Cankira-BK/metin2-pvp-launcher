<div class="row">
    <div class="col-md-9 normal-content">
        <div class="col-md-12 no-padding-all">
            <center><h3>Üyelik Sözleşmesi</h3></center>
            <h2 class="brackets"></h2>
        </div>
    <div class="col-md-12">
        <h2><span>Üyelik ve Hizmet Sözleşmesi</span></h2>
        <div class="box-con">
            <div class="box-con-wrap">
                <p style="text-align: center;">

                </p><p><span class="gradient">Üyelik ve Hizmet Sözleşmesi Beyanı</span></p>
