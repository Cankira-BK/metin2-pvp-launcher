<div class="col-md-9 normal-content">
    <div class="row">
        <ol class="breadcrumb grunge">
            <li><a href="index.php"><?=$lng[8]?></a></li>
    ...
    <div class="col-md-12">
		...
		<?php else:?>
			...
			?>
            <form class="form-horizontal" action="<?=URI::get_path('profile/aktivechange')?>" method="post" >
                ...
                <div class="row">
                    <div class="form-inline col-sm-offset-4 col-sm-8">
                        <button type="submit" class="btn btn-grunge"><?=$lng[104]?></button>
                    </div>
                </div>
            </form>
