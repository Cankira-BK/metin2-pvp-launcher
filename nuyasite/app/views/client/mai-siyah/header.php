...
<head>
    ...
    <link href="<?=URI::public_path()?>media/css/fancybox.css" rel="stylesheet" type="text/css" media="screen"/>
    <link href="<?=URI::public_path()?>media/css/jquery.fancybox.min.css" rel="stylesheet" type="text/css" media="screen"/>
    <script src="<?=URI::public_path()?>media/javascripts/jquery-2.1.4.min.js" type="text/javascript"></script>
    <script src="<?=URI::public_path()?>media/javascripts/bootstrap.min.js" type="text/javascript"></script>
    <script src="<?=URI::public_path()?>media/javascripts/alertify.js" type="text/javascript"></script>
    <script src="<?=URI::public_path()?>media/javascripts/jquery-ui.js" type="text/javascript"></script>
    <script src="<?=URI::public_path()?>media/javascripts/jquery.bxslider.min.js" type="text/javascript"></script>
    <script src="<?=URI::public_path()?>media/javascripts/jquery.blockUI.js" type="text/javascript"></script>
    <script src="<?=URI::public_path()?>media/javascripts/script.js" type="text/javascript"></script>
