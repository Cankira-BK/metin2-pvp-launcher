...
<aside id="right">
    <div id="content_ajax">
        <article class="page_article">
            <div class="panel-heading"><h2 class="head"><?=$lng[111]?><a href="<?=URI::get_path('profile')?>" class="back-to-account" title="Geri"></a></h2></div>
            <div class="body">
                <div class="error-holder">
                    <div class="container_3 red wide fading-notification" align="center">
						...
						<?php if ($this->aktive['mailaktive'] == 0):?>
                            ...
                            <a href="<?=URI::get_path('profile/aktive')?>" ><button type="submit" class="center-block btn btn-grunge form-btn"><?=$lng[114]?></button></a>
						<?php else:?>
						<?php
                ...
                <form action="<?=URI::get_path('profile/depochange')?>" method="POST" class="page_form" autocomplete="off" >
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
                            <button type="submit" name="login_submit" class="btn form-btn"><?=$lng[119]?></button>
                        </div>
                    </div>
                </form>
				<?php endif;?>
