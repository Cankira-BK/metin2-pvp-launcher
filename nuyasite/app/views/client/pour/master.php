...
<div id="exception"></div>
				<div class="top-panel">
					<div class="top-panel-container flex-center">
						<ul class="menu">
							<li class="active"><a href="<?=URI::get_path('index')?>"><?=$lng[8]?></a></li>
							...
							<li style="margin-right: 325px;"><a href="<?=URI::get_path('ranked/player')?>">Sıralama</a></li>
				...
				<div class="wrapper">
					<header class="header">
                        <div class="logo-header" href="<?=URI::get_path('index')?>">
					...
					<div class="container">
						<aside class="left-sidebar">
							...
							<div class="login-block border">
                                <div class="sidebar-title left-sidebar-title">
                                    Hesabım
                                </div>
							...
							<?php if ($urlLang[0] != 'register' && $urlLang[0] != 'login' && $urlLang[0] != 'recuperare'):?>
                                    <div class="login-block border">
                                        ...
                                        <form action="<?=URI::get_path('login/control')?>" id="LoginNotifyOGs" method="post" accept-charset="utf-8" autocomplete="off">
                                            <button class="buttongiris" type="submit" name="login_submit"><?=$lng[21]?></button>
											...
											<?php endif;?>
                                            <div class="g-recaptcha rc-anchor-blue" data-theme="light" style="transform:scale(0.81);-webkit-transform:scale(0.81);transform-origin:0 0;-webkit-transform-origin:0 0;" data-sitekey="<?=\StaticDatabase\StaticDatabase::settings('sitekey')?>"></div>
                                            <div class="p-block lost-block">
                                                <p><a href="<?=URI::get_path('recuperare')?>" data-hasevent="1" style="position: relative;top: -9px;"><?=$lng[25]?></a></p>
                                                <p><a href="<?=URI::get_path('recuperare/account')?>" data-hasevent="1" style="position: relative;top: -1px;"><?=$lng[26]?></a></p>
												<?php if(\StaticDatabase\StaticDatabase::systems('pin_durum') === "1"):?>
                                                    <a href="<?=URI::get_path('recuperare/pin')?>" data-hasevent="1" style="position: relative;top: 10px;margin-left: 0px;">PIN Unuttum</a>
												<?php endif;?>
                                            </div>
                                        </form>
                                        <script>
...
h1.YoutubeTitle {
    ...
    padding-left: 20px;
    background: #090f1785;
    border-bottom: 1px solid #a7930e;
    font-size: 14px;
    color: #a7930e;
