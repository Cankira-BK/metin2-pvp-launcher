<aside id="right">
    <div id="content_ajax">
        <article class="page_article">
            <div class="panel-heading"><h2 class="head"><?=$lng[32]?></h2></div>
            <div class="body">
						...
						<?php if (Cache::check($this->player['name']."_player")):?>
                            <section id="ucp_info" style="padding-right:15px;padding-left:15px;width: 100%;">
                                <aside class="detail-section">
                                    <div class="leader">
                                        <img src="<?=URL.'data/chrs/big/'.$this->player['job'].'/'.Functions::playerPortrait($this->player['level']).'.png'?>" style="width:200px">
                                    </div>
                                </aside>
                                <aside class="detail-section">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" class="wheat"><?= ($this->player['lonca'] == null) ? 'Yok' : $this->player['lonca']?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </aside>
                                <aside class="detail-section">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" class="wheat"><?=Functions::prettyDateTime1($this->player['last_play'])?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" class="wheat"><img src="<?=URL.'data/chrs/small/'.Functions::playerOnlineStatus($this->player['last_play']).'.png'?>" style="width: 12px;" alt=""></td>
                                        </tr>
                                        <tr>
                                            <td width="40%"><?=$lng[109]?> :</td>
                                            <td width="50%" class="wheat"><?=Functions::map($this->player['map_index'])?></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </aside>
