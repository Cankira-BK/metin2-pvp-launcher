...
<head>
    ...
    <link rel="stylesheet" href="<?=URI::public_path()?>asset/css/steelkof.css" type="text/css"/>
	...
	<link rel="stylesheet" type="text/css" href="<?=URI::public_path()?>main/css/selectbox.css"/>
    <link rel="stylesheet" type="text/css" href="<?=URI::public_path()?>main/css/radiocheck.css"/>
    <link rel="stylesheet" type="text/css" href="<?=URI::public_path()?>main/css/shadowbox.css"/>
	<link rel="stylesheet" href="<?=URI::public_path()?>main/css/rankings.css"/>
    <link rel="stylesheet" href="<?=URI::public_path()?>main/css/popup.css"/>
    <link rel="stylesheet" href="<?=URI::public_path()?>main/css/jquery.modal.css"/>
	...
	<script type="text/javascript" src="<?=URI::public_path()?>main/js/jquery.modal.min.js"></script>
	<script type="text/javascript" src="<?=URI::public_path()?>main/js/selectbox.min.js"></script>
    <script type="text/javascript" src="<?=URI::public_path()?>main/js/footer_include.js"></script>
    <script type="text/javascript" src="<?=URI::public_path()?>main/js/ui.js"></script>
    <script type="text/javascript" src="<?=URI::public_path()?>main/js/flux.min.js"></script>
    <script type="text/javascript" src="<?=URI::public_path()?>main/js/popup.js"></script>
