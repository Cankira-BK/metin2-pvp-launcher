...
<div class="content_wrapper left">
    <div class="real_content">
        ...
        <h2 class="headline_news active"><span><?=\StaticDatabase\StaticDatabase::settings('oyun_adi')?> | <?=$lng[32]?></span></h2>
            ...
            <div class="real_content">
                <div class="inner_content news_content">
                    ...
                    <style type="text/css">
                        ...
                        .title,
                        .main-title {width:630px;height:26px;text-align:center;text-transform:uppercase;font-size:15px;color:wheat;padding-top:8px;margin-top:5px;margin-bottom:15px;}
                    ...
                    <div class="value">
                        ...
                        <div class="table">
                            <div class="row">
                                <div class="cell CharLeft"> <div class="main-title CharChild"><?=$lng[33]?></div> <img src="<?=URL.'data/chrs/big/'.$this->player['job'].'/'.portrait($this->player['level']).'.png'?>" style="width: 145px">
                                    <div class="childrow Level">Level<br><span><?=$this->player['level']?></span></div>
                                    <div class="childrow"><b><?=$this->player['exp']?></b> <span>Exp</span></div>

                                </div> <div class="cell CharRight">
                                    <div class="main-title CharChild"><?=$lng[174]?></div>
                                    <div class="childrow"><span><?=$lng[35]?>:</span> <?=$this->player['name']?></div>
                                    <div class="childrow"><span><?=$lng[36]?>:</span> <?=jobName($this->player['job'])?></div>
                                    <div class="childrow"><span><?=$lng[37]?>:</span> <?=Functions::flagName($this->player['empire'])[1]?></div>
                                    <div class="childrow"><span><?=$lng[38]?>:</span> <?php if ($this->player['lonca'] == null){echo 'Yok';}else{echo $this->player['lonca'];}?> </div>

                                    <div class="childrow"><span><?=$lng[39]?>:</span> <b><?=Functions::zaman($this->player['last_play'])?></b> </div>
                                    <div class="childrow"><span><?=$lng[40]?>:</span> <b><?=$this->player['playtime']?> <?=$lng[42]?></b> </div>


                                    <div class="childrow"><span><?=$lng[41]?>:</span> <img src="<?=URL.'data/chrs/small/'.playerStat($this->player['last_play']).'.png'?>" style="width: 12px;" alt=""> </div>
                                </div>
                            </div>
                        </div>
						<?php endif;?>
