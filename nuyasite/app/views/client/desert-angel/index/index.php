...
<style type="text/css">
    ...
    .countDown{
        font-size: 22px;
        line-height: 55px;
        background: url(<?=URI::public_path('images/baslik.png')?>) no-repeat center center;
        text-align: center;
        height: 60px;
        line-height: 60px;
        font-weight: bold;
                        ...
                        <?php if (Cache::check('patch')):?>
                            <?php foreach ($this->result['patch'] as $row):?>
                                <div class="main-text">
                                    <div class="bg-light">
                                        <div class="fr-view">
                                            <p style="text-align: center;"><img src="<?=URL.$row['image']?>" style="width: 250px;" class="fr-fic fr-dib"></p><p style="text-align: center;">
                                    <span style="font-size: 20px; font-family: Tahoma, Geneva, sans-serif;">
                                        ...
                                        <div class="news-sig"><?=$lng[64]?> : <?=Functions::zaman($row['tarih'])?></div>
                                    </div>
                                </div>
                            <?php endforeach; ?>
                        <?php endif;?>
