                    ...
                    <div class="panel-content">
                        <div class="panel-inner">
                            <form method="POST" action="<?=URI::get_path('login/control')?>" id="LoginNotifyOGs">
                                ...
                                <div class="input input-rich">
                                    <input type="password" name="pin" id="password" maxlength="<?=\StaticDatabase\StaticDatabase::systems('pin_adet')?>" placeholder="PIN" />
                                </div>
				                <?php endif;?>
                        ...
                        <center><a href="<?=URI::get_path('recuperare')?>"><h4><i class="icon-lock position-left"></i> <?=$lng[25]?></h4></a></center><br>
                        <center><a href="<?=URI::get_path('recuperare/account')?>"><h4><i class="icon-user position-left"></i><?=$lng[26]?></h4></a></center>
                    </div>
                </div>
                <?php endif;?>
            <?php endif;?>
