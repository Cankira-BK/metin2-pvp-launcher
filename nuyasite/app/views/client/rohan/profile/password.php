        ...
        <div class="box">
          <div class="box registration-form">
            ...
            <div class="panel-body">
				...
				?>
                <form action="<?=URI::get_path('profile/passwordchange')?>" method="POST" class="form-horizontal" id="ProfileNotifyOGs">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
                            <button type="submit" class="btn btn-danger btn-block" style="margin-top: 10px;"> <?=$lng[141]?></button>
                        </div>
                    </div>
                </form>
				<?php endif;?>
