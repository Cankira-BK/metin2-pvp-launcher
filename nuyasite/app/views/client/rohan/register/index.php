        ...
        <div class="box">
          <div class="box registration-form">
            <h2><?=$lng[10]?></h2>
				...
				<?php else:?>
                    <form action="<?=URI::get_path('register/control')?>" method="POST" class="form-horizontal" id="RegisterNotifyOGs">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                <button type="submit" class="btn btn-danger btn-block" style="margin-top: 10px;"> <?=$lng[10]?></button>
                            </div>
                        </div>
                    </form>
                <?php endif;?>
