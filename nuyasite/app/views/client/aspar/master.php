	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3">
									...
									<form action="<?=URI::get_path('login/control')?>" id="LoginNotifyOGs" method="POST" onkeypress="return event.keyCode != 13;">
										...
										<?php if (\StaticDatabase\StaticDatabase::systems('pin_durum') === "1"): ?>
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-addon giris-addon" id="basic-addon2"><i class="glyphicon glyphicon-lock"></i></span>
                                                    <input type="password" class="form-control giris-input" name="pin" placeholder="PIN" aria-describedby="basic-addon2" maxlength="<?=\StaticDatabase\StaticDatabase::systems('pin_adet')?>" required="">
                                                </div>
                                            </div>
										<?php endif;?>
				...
				<div class="col-md-12 no-padding">
					<div class="panel panel-kucuk">
						<div class="panel-heading"><a href="<?=URI::get_path('ranked/player')?>" style="color: white"><?=$lng[65]?></a>
				...
				<div class="col-md-12 no-padding">
					<div class="panel panel-kucuk">
						<div class="panel-heading"><a href="<?=URI::get_path('ranked/guild')?>" style="color: white"><?=$lng[66]?></a>
							<i class="glyphicon glyphicon-user cache-bilgi" data-toggle="tooltip" data-placement="right"></i>
						</div>
						<div class="panel-body no-padding">
