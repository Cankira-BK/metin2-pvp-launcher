				...
				<div class="wrapper">
					<header class="header">
						...
						<div class="start-game">
							<a href="<?=URI::get_path('download')?>"><?=$lng[186]?></a>
						</div>
						<!-- start-game -->
					</header>
					<!-- .header-->
					<div class="container">
						<aside class="left-sidebar">
							...
							<?php else:?>
							<div class="login-block p-block">
								<form action="<?=URI::get_path('login/control')?>" method="post" id="LoginNotifyOGs" accept-charset="utf-8" onkeypress="return event.keyCode != 13;">
