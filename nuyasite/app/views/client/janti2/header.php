...
<meta name="generator" content="Nikolas F. Çelebi" />
...
<link href="<?=URI::public_path()?>assets/ThemeOne/css/css-reset.css" rel="stylesheet">
<link href="<?=URI::public_path()?>assets/ThemeOne/css/main.css" rel="stylesheet">
<link href="<?=URI::public_path()?>assets/ThemeOne/css/snrtr.css" rel="stylesheet">
...
<script src="<?=URI::public_path()?>assets/ThemeOne/js/jquery-2.1.4.min.js" type="text/javascript"></script>
<script src="<?=URI::public_path()?>assets/ThemeOne/js/modalx.js" type="text/javascript"></script>
<script src="<?=URI::public_path()?>assets/ThemeOne/js/slider.js" type="text/javascript"></script>
<script src="<?=URI::public_path()?>assets/ThemeOne/js/mask.js" type="text/javascript"></script>
<script src="<?=URI::public_path()?>assets/js/fancybox.js" type="text/javascript"></script>
<script src="<?=URI::public_path()?>assets/js/ajax.js" type="text/javascript"></script>
<script src="<?=URI::public_path()?>assets/ThemeOne/js/main.js" type="text/javascript"></script>
