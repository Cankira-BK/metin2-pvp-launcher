<div id="content_ajax" class="haberler">
	...
	<?php foreach ($this->result['patch'] as $row):?>
            <div class="panel panel-buyuk Renk-1">
                <div class="panel-heading"><a href="<?=URI::get_path('patch/view/'.$row['id'])?>"><?=$row['title'];?></a></div>
	...
	<div class="haber haber-1" style="color: #efef67;">
		...
		<div id="fb" class="facebook">
			...
			<div id="fbContent" class="fb-page" data-href="<?=\StaticDatabase\StaticDatabase::settings('facebook')?>" data-tabs="timeline" data-width="462" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false" style="display: none;margin-left: 85px;"></div>
		</div>
		<script>
        ...
        <center>
            ...
            <a href="<?=\StaticDatabase\StaticDatabase::settings('facebook')?>" target="_blank">
                <div class="facebook-like">
                    <img src="<?=URI::public_path('global/images/face.png')?>" alt="">
