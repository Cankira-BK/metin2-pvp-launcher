        ...
        <section id="ucp_top">
			...
			<?php if (Cache::check($guild['name']."_guild")):?>
                <section id="ucp_info" style="padding-right:15px;padding-left:15px;width: 100%;">
                    ...
                    <aside class="detail-section">
                        <div class="leader">
                            <img src="<?=URL.'data/chrs/big/'.$guild['job'].'/'.Functions::playerPortrait($guild['seviye']).'.png'?>" alt="<?=\StaticDatabase\StaticDatabase::settings('oyun_adi')?>" style="width:100px;margin-right: auto;margin-left: auto;display: block;">
