    ...
    <div class="f-info">
        ...
        <div class="design">
            <a href="https://www.viphosting.com.tr" target="_blank">
                <img src="<?=URL.'data/upload/logo-white-mini.png'?>" style="display: block;width: 100px;margin-right: auto;margin-left: auto;" alt="Metin2 PVP Sunucuları">
            </a>
        </div>
    </div>
</footer><!-- .footer -->
...
<div id="loginModal" class="modalDialog">
    <div class="login-modal-content">
		...
		<?php else:?>
            <form id="loginFormMaster" action="<?=URI::get_path('login/control')?>" method="POST" class="page_form" autocomplete="off">
                <p>
                ...
                <div class="modal-button">
                    <button type="button" onclick="loginFormFunction();"><?=$lng[21]?></button>
                </div>
            </form>
            <br>
            <p>
    ...
    <div class="register-modal-content">
		...
		<?php else:?>
                <form id="registerFormMaster" action="<?=URI::get_path('register/control')?>" method="POST" class="page_form" autocomplete="off">
                    ...
                    <div class="modal-button">
                        <button type="button" onclick="registerFormFunction();">Kayıt Ol</button>
                    </div>
                </form>
		<?php endif;?>
    </div>
