...
<head>
	...
	<link href="<?=URI::public_path('assets/css/style-1.css')?>" rel="stylesheet" type="text/css"/>
	<link href="<?=URI::public_path('assets/css/style-2.css')?>" rel="stylesheet" type="text/css"/>
    <link href="<?=URI::public_path('')?>assets/css/fancybox.css" rel="stylesheet" type="text/css" media="screen"/>
    <!--[if lt IE 7]>
	<link rel="stylesheet" type="text/css" href="<?=URI::public_path('assets/css/ie-1.css')?>"/>
	<![endif]-->
	<!--[if gte IE 6]>
	<link rel="stylesheet" type="text/css" href="<?=URI::public_path('assets/css/ie-2.css')?>"/>
	<![endif]-->
	<script type="text/javascript" src="<?=URI::public_path('assets/js/jquery.js')?>"></script>
    <script type="text/javascript" src="<?=URI::public_path('')?>assets/js/fancybox.js"></script>
    <script type="text/javascript" src="<?=URI::public_path('assets/js/valid.js')?>"></script>
	<script type="text/javascript" src="<?=URI::public_path('assets/js/valid-rules.js')?>"></script>
	<script type="text/javascript" src="<?=URI::public_path('assets/js/gfix.js')?>"></script>
	<script type="text/javascript" src="<?=URI::public_path('assets/js/main-2.js')?>"></script>
	<script type="text/javascript" src="<?=URI::public_path('assets/js/main-3.js')?>"></script>
	<script type="text/javascript" src="<?=URI::public_path('assets/js/main-4.js')?>"></script>
	<script type="text/javascript" src="<?=URI::public_path('assets/js/main-5.js')?>"></script>
	<script type="text/javascript" src="<?=URI::public_path('assets/js/main-6.js')?>"></script>
