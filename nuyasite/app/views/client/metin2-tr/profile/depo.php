                ...
                <div class="inner-form-border">
                    <div class="inner-form-box">
						...
						<?php if ($this->aktive['mailaktive'] == 0):?>
                            ...
                            <a href="<?=URI::get_path('profile/aktive')?>" ><button type="submit" class="center-block btn btn-grunge" style="margin-right: auto;margin-left: auto;"><?=$lng[114]?></button></a>
						<?php else:?>
						<?php
						...
						?>
                        <form name="loginForm" action="<?=URI::get_path('profile/depochange')?>" method="POST">
                            <div>
