								...
								<?php foreach ($this->views['data'] as $key=>$row):?>
									<?php if ($key % 2 == 0):?>
                                        <tr class="rankfirst zebra">
                                            ...
                                            <td class="rank-td-1-2"><?=$row['lonca']?></td>
                                            <td class="rank-td-1-4"><?=$row['baskan']?></td>
                                            <td class="rank-td-1-3"><img src="<?=URL.'data/flags/'.$row['bayrak'].'.png'?>" width="34" alt="Chunjo Krallığı" title="Chunjo Krallığı"></td>
                                            <td class="rank-td-1-5"><?=$row['ladder_point'];?></td>
                                            <td class="rank-td-1-5"><?=$row['win']?></span> | <span class="label label-draw"><?=$row['draw']?></span> | <span class="label label-red"><?=$row['loss']?></span></td>
                                        </tr>
									<?php else:?>
                                        <tr>
                                            <td class="rank-td-1-1"><?=($key+1)?></td>
                                            ...
                                            <td class="rank-td-1-3"><img src="<?=URL.'data/flags/'.$row['bayrak'].'.png'?>" width="34" alt="Chunjo Krallığı" title="Chunjo Krallığı"></td>
                                            <td class="rank-td-1-5"><?=$row['ladder_point'];?></td>
                                            <td class="rank-td-1-5"><span><?=$row['win']?></span> | <span class="label label-draw"><?=$row['draw']?></span> | <span class="label label-red"><?=$row['loss']?></span></td>
                                        </tr>
									<?php endif;?>
								<?php endforeach;?>
							<?php endif;?>
