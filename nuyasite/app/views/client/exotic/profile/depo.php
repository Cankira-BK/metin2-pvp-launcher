                    ...
                    <div class="container_3 account-wide" align="center">
						...
						<?php if ($ban['status'] == 'OK' && $availDt <= $now):?>
							...
							<?php else:?>
								...
								?>
                                <form action="<?=URI::get_path('profile/depochange')?>" method="POST">
                                    ...
                                    <div class="row" style="margin-top: 30px;">
                                        <div class="wbuttons wbuttons-buttonBorder">
                                            <input type="submit" value="<?=$lng[119]?>" class="wbuttons wbuttons-bt" AutoCompleteType="None" />
                                        </div>
                                    </div>
                                </form>
							<?php endif;?>
