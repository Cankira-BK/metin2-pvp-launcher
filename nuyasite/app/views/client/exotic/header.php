...
<head>
	...
	<!--Css Folders-->
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/headback.css" />
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/usermenu.css" />
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/windows.css" />
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/wbuttons.css" />
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/style.css" />
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/ranktable.css" />
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/radio-checkbox.css" />
	<link rel="stylesheet" href="<?=URI::public_path()?>assets/css/slider.css" />
	...
	<script type="text/javascript" src="<?=URI::public_path()?>assets/js/jquery.plugins.js"></script>
	<script type="text/javascript" src="<?=URI::public_path()?>assets/js/jquery.countdown.js"></script>
	<script type="text/javascript" src="<?=URI::public_path()?>assets/js/wrc.js"></script>
	<script type="text/javascript" src="<?=URI::public_path()?>assets/js/notify.js"></script>
