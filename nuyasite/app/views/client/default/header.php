...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=URI::public_path('assets/css/style.css')?>"/>
    <link href="<?=URI::public_path('assets/css/fancybox.css')?>" rel="stylesheet" type="text/css" media="screen"/>    <link rel="stylesheet" type="text/css" href="<?=URI::public_path('assets/css/extra.css')?>"/>

    <script type="text/javascript" src="<?=URI::public_path('assets/js/jquery.min.js')?>"></script>
    <script type="text/javascript" src="<?=URI::public_path('assets/js/mainscript.js')?>"></script>
