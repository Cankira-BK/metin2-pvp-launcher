...
<div class="content_wrapper left">
	<div class="real_content">
		<h2 class="headline_news active"><span class="title"><?=\StaticDatabase\StaticDatabase::settings('oyun_adi')?> | <?=$lng[184]?></span></h2>
			<div class="p4px" style="display: block;">
				<div class="real_content">
					...
					else{echo Functions::alert('info',$lng[185]);}
					?>
						<form action="<?=URI::get_path('profile/gpcchange')?>" method="post" id="BirForm">
