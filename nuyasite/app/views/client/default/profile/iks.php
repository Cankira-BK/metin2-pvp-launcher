...
<div class="content_wrapper left">
	<div class="real_content">
		<h2 class="headline_news active"><span class="title"><?=\StaticDatabase\StaticDatabase::settings('oyun_adi')?> | <?=$lng[191]?></span></h2>
			<div class="p4px" style="display: block;">
				<div class="real_content">
					...
					elseif($cError == 'OK')
					{
						echo Functions::alert('success',$lng[196]);
						Session::set('cError',false);
					}
					elseif($cError == 'time')
					{
					...
					else{echo Functions::alert('info',$lng[192]);}
					?>
						<form action="<?=URI::get_path('profile/ikschange')?>" method="post" id="BirForm">
							<table border="0" align="center" width="100%">
							<tbody>
							<tr>
							<td align="center">
								<label><?=$lng[23]?> :<span style="color:darkred;text-shadow:none;">*</span><br>
							...
							<tr>
							<td align="center">
								<label><?=$lng[24]?> :<span style="color:darkred;text-shadow:none;">*</span><br>
							...
							<td align="center">
							<br>
								<input type="submit" value="<?=$lng[193]?>">
								<div class="clear"></div>
							<br>
							</td>
							</tr>
