		...
		<div id="content_main">
			<div class="inner_wrapper">
				...
				<div class="content_wrapper right">
                    ...
                    <div class="real_content">
                        <div id="ServeurStats">
                            <div class="headline"><span class="title">Etkinlik Takvimi</span></div>
                            <div class="inner_content">
                                <div id="ServerStatus">
                                    <?php if(\StaticDatabase\StaticDatabase::settings('event_type') == "1"):?>
                                        <iframe src="<?=URI::get_path('event')?>" style="border: none;width: 210px;height: 300px;left: 30px;" id="fancybox-frame"></iframe>
									<?php else:?>
