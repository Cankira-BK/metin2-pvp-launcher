<?php if (Functions::checkAllPermission($_SESSION['allPermissionArray'],"11") == true):?>
<?php
    /**
     * Created by PhpStorm.
     * User: User
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Kullanılmış Kuponlar</span>
                </div>
                <div class="tools"> </div>
            </div>
