<?php if (Functions::checkAllPermission($_SESSION['allPermissionArray'],"73") == true):?>
<style>
	/* common */
	.ribbon {
		width: 150px;
		...
		<div class="portlet light portlet-fit bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-green bold uppercase">Tema Ayarları</span>
				</div>
			</div>
			<div class="portlet-body">
				<div id="themeList" class="mt-element-card mt-element-overlay">
					<div class="row">
						<form action="<?=URI::get_path('site/themeselect');?>" method="post">
							<?php 
							$dir = "./app/public/client/";
							$handle = @opendir($dir);
							$say = 0;
								...
								<div class="mt-card-item">
									...
									<div class="mt-card-content">
										...
										<div class="mt-card-social">
											<ul>
												<?php if($GetTheme == $file){?>
												<li><button id="install_<?php echo $file;?>" type="button" disabled class="btn btn-success">Varsayılan</button></li>
												<?php }else{ ?>
												<li><button type="submit" data-style="contract" name="client" value="<?=$file;?>" class="btn btn-primary">Varsayılan olarak ayarla</button></li><?php } ?>
											</ul>
										</div>
									</div>
								</div>
