<div class="row" style="margin-bottom: 25px;">
    <div class="col-md-12">
        <a href="<?=URI::get_path('ticket/unreadmy')?>" class="btn red text-center">
            Bana ait Ticketlar (Yanıtlanmamış)
        </a>
        <a href="<?=URI::get_path('ticket/unreadnull')?>" class="btn dark text-center">
            Yönetici Atanmamış Ticketlar (Yanıtlanmamış)
        </a>
        <a href="<?=URI::get_path('ticket/unreadother')?>" class="btn blue text-center">
            Diğer Yöneticilere Ticketlar (Yanıtlanmamış)
        </a>
    </div>
</div>
<div class="row">
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover order-column" id="sample_1">
                    ...
                    <tbody>
                    <?php foreach ($this->unreadother as $key=>$row):?>
                        ...
                        <tr>
                            ...
                            <td><?=$row['title'];?></td>
                            <td><?=$message?></td>
                            <td><span class="label label-sm label-primary"> <?=$row['whoname']?> </span></td>
                            <td><?=$row['tarih'];?></td>
