<?php if (Functions::checkAllPermission($_SESSION['allPermissionArray'],"19") == true):?>
<!DOCTYPE html>
...
<head>
    <meta charset="utf-8" />
    <title><?=\StaticDatabase\StaticDatabase::settings('oyun_adi')?> | DB Bilgilerini Güncelle</title>
...
<div class="page-lock">
    ...
    <div class="page-body">
        ...
        <div class="lock-body">
            <form class="lock-form pull-left" action="<?=URI::get_path('setting/index')?>" method="post">
                <div class="form-group">
                    <input class="form-control placeholder-no-fix"  style="width: 290px;" type="text" autocomplete="off" placeholder="Database Key" name="key" />
                </div>
                ...
                <?php if($getDbKey != null): ?>
                    <div class="form-actions">
                        <a href="<?=URI::get_path('setting/index2')?>"><button type="button"  style="width: 290px;" class="btn white uppercase">Geç</button></a>
                    </div>
                <?php endif; ?>
            </form>
        </div>
