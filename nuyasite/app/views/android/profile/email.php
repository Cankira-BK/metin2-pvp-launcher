...
$cError = Session::get('cError');
		if($cError == 'recaptcha'){
			...
			echo Functions::AndroidErrorMessage('success',$lng[144]);
			Session::set('cError',false);
		} elseif($cError == 'OK3'){
			echo Functions::AndroidErrorMessage('success',$lng[145]);
			Session::set('cError',false);
		}elseif($cError == 'time'){
			$now = date('i');
			...
			echo Functions::AndroidErrorMessage('info',$lng[121]);
		}
?>
<div class="container no-bottom">
<div class="contact-form no-bottom">
<form action="<?=URI::get_path('profile/emailchange2')?>" method="POST" class="contactForm">
<fieldset>
...
if($cError == 'recaptcha'){
	...
	echo Functions::AndroidErrorMessage('error',$lng[148]);
	Session::set('cError',false);
}elseif($cError == 'empty'){
	echo Functions::AndroidErrorMessage('error',$lng[148]);
	Session::set('cError',false);
}elseif($cError == 'wrong'){
	echo Functions::AndroidErrorMessage('error',$lng[149]);
	Session::set('cError',false);
}elseif($cError == 'length'){
	echo Functions::AndroidErrorMessage('error',$lng[150]);
	Session::set('cError',false);
}elseif($cError == 'length2'){
	echo Functions::AndroidErrorMessage('error',$lng[151]);
	Session::set('cError',false);
}elseif($cError == 'format'){
	echo Functions::AndroidErrorMessage('error',$lng[152]);
	Session::set('cError',false);
}elseif($cError == 'error'){
	echo Functions::AndroidErrorMessage('error',$lng[153]);
	Session::set('cError',false);
}elseif($cError == 'OK'){
	echo Functions::AndroidErrorMessage('success',$lng[154]);
	Session::set('cError',false);
}
?>
<div class="container no-bottom">
<div class="contact-form no-bottom">
<form action="<?=URI::get_path('profile/emailchange')?>" method="POST" class="contactForm">
<fieldset>
