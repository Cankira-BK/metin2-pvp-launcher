...
if($cError == 'recaptcha'){
	...
	echo Functions::AndroidErrorMessage('success',$lng[142]);
	Session::set('cError',false);
}elseif($cError == 'time'){
	$now = date('i');
	...
	echo Functions::AndroidErrorMessage('info',$lng[122]);
}
?>
...
<form action="<?=URI::get_path('profile/depochange')?>" method="POST" class="contactForm">
<fieldset>
...
<input type="submit" class="buttonWrap button button-green contactSubmitButton" value="<?=$lng[97]?>" />
</div>
</fieldset>
</form>
</div>
