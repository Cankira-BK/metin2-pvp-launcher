...
if($cError == 'recaptcha'){
	...
	echo Functions::AndroidErrorMessage('success',$lng[155]);
	Session::set('cError',false);
}elseif($cError == 'time'){
	$now = date('i');
	...
	echo Functions::AndroidErrorMessage('info',$lng[156]);
}
?>
...
<form action="<?=URI::get_path('profile/kskchange')?>" method="POST" class="contactForm">
<fieldset>
...
<input type="submit" class="buttonWrap button button-green contactSubmitButton" value="<?=$lng[125]?>" />
</div>
</fieldset>
</form>
</div>
