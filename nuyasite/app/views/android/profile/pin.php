...
if($cError == 'recaptcha'){
	...
	echo Functions::AndroidErrorMessage('success',$lng[196]);
	Session::set('cError',false);
}elseif($cError == 'time'){
	$now = date('i');
	...
	echo Functions::AndroidErrorMessage('info',$lng[126]);
}
?>
...
<form action="<?=URI::get_path('profile/pinchange')?>" method="POST" class="contactForm">
<fieldset>
...
<input type="submit" class="buttonWrap button button-green contactSubmitButton" value="<?=$lng[127]?>" />
</div>
</fieldset>
</form>
</div>
