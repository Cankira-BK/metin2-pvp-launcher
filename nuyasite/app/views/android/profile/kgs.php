...
if($cError == 'recaptcha'){
	...
	echo Functions::AndroidErrorMessage('success',$lng[199]);
	Session::set('cError',false);
}elseif($cError == 'time'){
	$now = date('i');
	...
	echo Functions::AndroidErrorMessage('info',$lng[132]);
}
?>
...
<form action="<?=URI::get_path('profile/kgschange')?>" method="POST" class="contactForm">
<fieldset>
...
<input type="submit" class="buttonWrap button button-green contactSubmitButton" value="<?=$lng[133]?>" />
</div>
</fieldset>
</form>
</div>
