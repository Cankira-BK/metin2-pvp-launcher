...
if($cError == 'recaptcha'){
	...
	echo Functions::AndroidErrorMessage('success',$lng[200]);
	Session::set('cError',false);
}elseif($cError == 'time'){
	$now = date('i');
	...
	echo Functions::AndroidErrorMessage('info',$lng[134]);
}
?>
...
<form action="<?=URI::get_path('profile/gpcchange')?>" method="POST" class="contactForm">
<fieldset>
...
<input type="submit" class="buttonWrap button button-green contactSubmitButton" value="<?=$lng[135]?>" />
</div>
</fieldset>
</form>
</div>
