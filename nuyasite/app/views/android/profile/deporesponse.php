...
<?php elseif ($this->response['result'] == true):?>
	<?php echo Functions::AndroidErrorMessage('success',$lng[169]);?>
    <h3 class="header-3" style="font: normal 25px 'Palatino Linotype', 'Times', serif; text-transform: none;"><?=$lng[170]?> : <?=$this->response['data']?></h3>
<?php endif;?>
</div>
</div>