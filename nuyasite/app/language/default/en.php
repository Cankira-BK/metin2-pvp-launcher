...
$lng = [
	...
	"Secure Computer",
	"When you press Secure Computer Disable button, a link will be sent to your registered e-mail address. Please disable your secure computer status by following the link.",
	"Secure Computer Passive",
	"Secure Computer successfully disabled",
	"Your safe computer settings have been successfully disabled, please remember to activate again after logging in!",
	"Secure computer passivation link has been sent to your e-mail address. Please check.",
	"Secure Computer deactivates.",
	"Item Locking",
	"Item Lock Password When you press Reset button, a link will be sent to your registered e-mail address. Please follow the link to reset your item lock password.",
	"Item Lock Reset Password",
	"Item Lock Password has been successfully reset",
	"Item Lock Password has been successfully reset, don't forget to write down your new password!",
	"Item Lock Password Reset link has been sent to your e-mail address. Please check.",
	"Item Lock Resets your password."
];
