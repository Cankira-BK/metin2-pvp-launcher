var Login = function () {
    ...
    return {
        init: function () {
            e(), s(), $.backstretch([url+"app/public/admin/pages/media/bg/1.jpg", url+"app/public/admin/pages/media/bg/2.jpg", url+"app/public/admin/pages/media/bg/3.jpg", url+"app/public/admin/pages/media/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
